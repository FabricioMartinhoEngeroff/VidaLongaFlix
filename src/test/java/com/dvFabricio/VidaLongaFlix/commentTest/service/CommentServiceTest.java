...
//
//        createCommentDTO = new CreateCommentDTO(comment.getId(), comment.getText(), comment.getDate(), user.getId(), video.getId());
//    }
//
//
//    @Test
...
//
//        assertDoesNotThrow(() -> commentService.create(createCommentDTO));
//
...
//
//        DuplicateResourceException exception = assertThrows(DuplicateResourceException.class, () -> commentService.create(createCommentDTO));
//
...
//
//        List<CreateCommentDTO> comments = commentService.getCommentsByUser(user.getId());
//
...
//
//        List<CreateCommentDTO> comments = commentService.getCommentsByVideo(video.getId());
//
//        assertEquals(1, comments.size());
//        assertEquals(comment.getText(), comments.get(0).text());
